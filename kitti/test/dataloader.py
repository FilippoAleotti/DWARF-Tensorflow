...
from main_utils.flow_utils import tf_load_flow_pfm
...
class Loader(GeneralLoader):
    ...
    def load_images(self, line):
        ...
        images.append(read_image(self.image_paths[0])) # add again the left_t0, in order to know the original shape
        return images
    ...
    def get_next_batch(self):
        ...
        batch['final_shape'] = tf_get_height_width(self.batch[-1]) # original height and width
        return batch